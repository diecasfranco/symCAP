...
parser.add_argument('--work_dir','-w',  default=os.getcwd(), help='Input directory containing genomes to annotate')
#parser.add_argument('--work_dir','-w',  required=True, help='Input directory containing genomes to annotate')
parser.add_argument('-i', '--genomes_for_annotation_dir', required=True, help='Input directory containing genomes to annotate')
#parser.add_argument('-o', '--output_dir', required=True, help='Output directory for annotation results')
parser.add_argument('-p', '--protein_ref_dir', required=True, help='input directory with protein files')
...
parser.add_argument('-pu', '--putative', type=float, default=0.9, help='Threshold for putative genes (default: 0.9)')
...
#### Uses pyrodigal (prodigal upgrade)
