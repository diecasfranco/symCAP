...
parser.add_argument('--genomes_dir', type=str, required=True, help='Directory with genomes to annotate')
parser.add_argument('--protein_ref_dir', type=str, required=True, help='Directory with protein reference alignments')
parser.add_argument('--rRNA_ref_dir', type=str, required=True, help='Directory with rRNA reference alignments')
parser.add_argument('--gene_detail_table', type=str, required=True, help='Table with gene details')
parser.add_argument('--Translation_table', type=int, required=True, help='Translation table')
...
genomes_for_annotation_dir = args.genomes_dir
protein_ref_dir = args.protein_ref_dir
rRNA_ref_dir = args.rRNA_ref_dir
gene_detail_table = args.gene_detail_table
Translation_table = args.Translation_table ### Spiroplasma, Hodgkinia, Nasuia, Vidania 11: Sulcia, bacteria; 4: Mitogenome					
