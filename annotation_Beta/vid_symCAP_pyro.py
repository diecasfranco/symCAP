...
work_dir = "/home/diego/Documents/metagenomes/annotation_symbio_merge/annotation_Beta/round6_pyro/"
...
rRNA_ref_dir = "/home/diego/Documents/metagenomes/annotation_symbio_merge/annotation_Beta/RNAs/"

  ### Table with detailed information about every gene: name, EC number, etc.
gene_detail_table = "/home/diego/Documents/metagenomes/annotation_symbio_merge/annotation_Beta/vidania_gene_list.txt"
...
Translation_table = 11	### As defined by getorf / NCBI!
						### Spiroplasma, Hodgkinia, Nasuia, Vidania 11: Sulcia, bacteria; 4: Mitogenome
...
if "B12" in Blocks_to_run:
    ...
    for genome in genome_list:
        ...
        if not glob.glob(path_to_output):
            os.system("tRNAscan-SE --thread 24 -D -B -q -o %s %s > temp" % (path_to_output, path_to_genome))
...
if "B15" in Blocks_to_run:
    ...
    GENE_TABLE = open("%s/annotation/genome_contents_table.txt" % work_dir, 'w')
    TABLE = []
